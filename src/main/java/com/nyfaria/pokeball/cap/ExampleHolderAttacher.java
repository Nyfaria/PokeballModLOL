package com.nyfaria.pokeball.cap;
...
@Mod.EventBusSubscriber(modid = Pokeball.MODID)
public class ExampleHolderAttacher extends CapabilityAttacher {
    ...
    public static final ResourceLocation EXAMPLE_RL = new ResourceLocation(Pokeball.MODID, "example");
