...
import com.nyfaria.pokeball.entity.PokeballEntity;
...
import static com.nyfaria.pokeball.Pokeball.MODID;
...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<PokeballEntity>> POKEBALL =registerEntity("pokeball", () -> EntityType.Builder.of(PokeballEntity::new, MobCategory.MISC));
